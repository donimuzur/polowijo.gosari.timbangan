...
namespace polowijo.gosari.timbangan.dal
{
    ...
    public partial class TIMBANGANEntities : DbContext
    {
        public TIMBANGANEntities()
            : base("name=TIMBANGANEntities")
        {
        }
        ...
        public DbSet<SO_BAHAN_BAKU> SO_BAHAN_BAKU { get; set; }
        public DbSet<SO_BAHAN_BAKU_DETAILS> SO_BAHAN_BAKU_DETAILS { get; set; }
